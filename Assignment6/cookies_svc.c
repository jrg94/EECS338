...
static void
cookie_jar_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		struct CookieStruct get_me_my_cookie_1_arg;
	} argument;
	char *result;
	...
	case GET_ME_MY_COOKIE:
		_xdr_argument = (xdrproc_t) xdr_CookieStruct;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) get_me_my_cookie_1_svc;
		break;
